...
typedef enum
{
    SSEverNoteTypeSandbox = 1, /**< 沙箱 */
    SSEverNoteTypeCN = 1 << 1, /**< 印象笔记 */
    SSEverNoteTypeUS = 1 << 2, /**< Evernote International */
    SSEverNoteTypeCNSandbox = (SSEverNoteTypeCN | SSEverNoteTypeSandbox),   /**< 印象笔记中国版沙箱模式 */
    SSEverNoteTypeUSSandbox = (SSEverNoteTypeUS | SSEverNoteTypeSandbox),   /**< 印象笔记国际版沙箱模式 */
    SSEverNoteTypeCNAndUS = (SSEverNoteTypeCN | SSEverNoteTypeUS),          /**< 印象笔记国际版和国外版 */
    SSEverNoteTypeCNAndUSSandbox = (SSEverNoteTypeCN | SSEverNoteTypeUS | SSEverNoteTypeSandbox) /**< 印象笔记国际版和国外版沙箱模式 */
}
SSEverNoteType;
