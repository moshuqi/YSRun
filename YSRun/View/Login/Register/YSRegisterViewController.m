...
@interface YSRegisterViewController () <YSPhoneTextFieldLimitDelegateCallback, YSNetworkManagerDelegate, YSContentCheckIconChangeDelegate, YSEditingCheckLengthLimitDelegate, YSTextFieldDelegateObjCallBack>
